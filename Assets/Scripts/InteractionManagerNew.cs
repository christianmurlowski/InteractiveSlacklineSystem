...
/// </summary>
public interface InteractionListenerInterfaceNew
{
  /// <summary>
...
/// </summary>
public class InteractionManagerNew : MonoBehaviour 
{
  /// <summary>
  ...
  private static InteractionManagerNew instance;
  ...
  /// <value>The InteractionManager instance.</value>
    public static InteractionManagerNew Instance
    {
        get
        {
            return instance;
...
//          monoScript.enabled)
        if((monoScript is InteractionListenerInterfaceNew) && monoScript.enabled)
        {
            ...
            ((leftHandPos - lastLeftHandPos).magnitude < KinectInterop.Constants.ClickMaxDistance))
          {
            if((Time.realtimeSinceStartup - lastLeftHandTime) >= KinectInterop.Constants.ClickStayDuration)
            {
              if(!isLeftHandClick)
              {
                ...
                foreach(InteractionListenerInterfaceNew listener in interactionListeners)
                {
